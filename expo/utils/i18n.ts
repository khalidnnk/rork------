...
const ar = {
  ...
  locationUpdated: 'نوّرت {location} 🤍، وتم تحديث مواقيت الصلاة حسب موقعك الحالي.',
...
const en: Record<TranslationKey, string> = {
  ...
  alwaysLocationTitle: 'Always Location access required', alwaysLocationMessage: 'To update prayer times while traveling without opening the app, choose Always for Location in device Settings.', autoUpdateFailed: 'Could not enable automatic updates', checkLocationPermission: 'Check Location permission and try again.',
